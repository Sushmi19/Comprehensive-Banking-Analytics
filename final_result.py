...
model_credit_score = joblib.load(r'credit_score_model.pkl')
imputer_kmeans = joblib.load(r'imputer.pkl')
scaler_kmeans = joblib.load(r'scaler.pkl')
kmeans_model = joblib.load(r'kmeans_model.pkl')
model_credit_risk = joblib.load(r'rf_model.pkl')
scaler_credit_risk = joblib.load(r'scaler1.pkl')
model_investment = joblib.load(r'lr_model.pkl')
scaler_investment = joblib.load(r'scaler2.pkl')
